...
export const metadata: Metadata = {
  title: 'AI Data Centers: Energy, Water, Economics & Regulation',
  description:
    'A comprehensive look at AI data center energy use, water consumption, economic impact, public health concerns, and the global regulatory response.',
  openGraph: {
    title: 'AI Data Centers: Energy, Water, Economics & Regulation',
    description:
      'The complete picture on AI data center energy use, water consumption, economic impact, public health, and global regulation.',
    type: 'website',
  },
}
...
function HighlightBox({
  ...
  const classMap = {
    info:    'bg-blue-50 border border-blue-200 dark:bg-blue-950/60 dark:border-blue-800',
    warning: 'bg-amber-50 border border-amber-200 dark:bg-amber-950/60 dark:border-amber-700',
    danger:  'bg-red-50 border border-red-200 dark:bg-red-950/60 dark:border-red-800',
    success: 'bg-green-50 border border-green-200 dark:bg-green-950/60 dark:border-green-800',
  }
  return (
    <div className={`rounded-xl px-6 py-5 my-6 text-sm leading-7 ${classMap[variant]}`}>
      {children}
    </div>
  )
}
...
function PerspectiveBox({
  ...
  const bgClassMap = {
    concern: 'bg-red-50 dark:bg-red-950/40',
    counter: 'bg-green-50 dark:bg-green-950/40',
    nuance:  'bg-amber-50 dark:bg-amber-950/40',
  }
  ...
  return (
    <div
      className={`rounded-r-xl rounded-l-sm p-6 my-8 text-sm leading-7 ${bgClassMap[variant]}`}
      style={{ borderLeft: `5px solid ${borderColorMap[variant]}` }}
    >
...
export default function DataCenterInfoPage() {
  return (
    <>
      {/* ── Hero ───────────────────────────────────────────────────────────── */}
      <div
      ...
      >
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-lg opacity-90 max-w-2xl mx-auto">
            A comprehensive look at energy use, water consumption, economic impact, public health, and the global regulatory response to the AI infrastructure boom
          </p>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-10">
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-2 text-sm leading-7" style={{ color: 'var(--pan-body)' }}>
            ...
            <li>
              <strong>Efficiency:</strong> Average PUE dropped from <strong>2.5 in 2007 to 1.56 in 2024</strong>. Google and Meta now operate at PUE of 1.08–1.09.
            </li>
            <li>
        ...
        <Para>
          The data center industry is experiencing what analysts at the Brookings Institution describe as an &ldquo;infrastructure investment supercycle&rdquo; driven almost entirely by the artificial intelligence revolution. Over <strong>700 data centers</strong> are actively under construction across <strong>38 U.S. states</strong>, representing approximately <strong>18 gigawatts of new capacity</strong>. Texas leads with 140 projects, followed by Virginia with 136, Georgia with 56, and Ohio with 51.
        </Para>
        ...
        <ChartImage
          ...
          caption="U.S. data center electricity consumption has nearly tripled in a decade, with AI driving the most recent acceleration. Source: Lawrence Berkeley National Laboratory, 2024."
        />
        ...
        <ChartImage
          ...
          caption="IEA scenarios for global data center electricity consumption through 2030. Even aggressive growth projections keep data centers below 3% of global electricity use. Source: IEA Energy and AI Report, 2025."
        />
        ...
        <ChartImage
          ...
          caption="Data center water consumption in context. Left: absolute gallons by sector. Right: share of U.S. freshwater withdrawals. Sources: USGS, Circle of Blue, industry reports."
        />

        <Para>
          In Maricopa County, Arizona — one of the most water-stressed regions where significant data center construction is occurring — all data centers are projected to use approximately <strong>905 million gallons in 2025</strong>. County golf courses consume <strong>29 billion gallons annually</strong>. Data centers generate approximately <strong>50 times as much tax revenue per gallon of water used</strong> as golf courses.
        </Para>
        ...
        <ChartImage
          ...
          caption="Public opinion polling shows data centers are less welcome than nearly any other type of infrastructure facility. Source: Heatmap News national poll, 2025."
        />
        ...
        <ChartImage
          ...
          caption="Data centers generate exceptional tax revenue relative to their consumption of public services. Source: JLL Research, Loudoun County data."
        />
        ...
        <ChartImage
          ...
          caption="Power Usage Effectiveness has improved dramatically since 2007, with leading operators now approaching the theoretical limit. Source: Uptime Institute, Google, Meta sustainability reports."
        />
        ...
        <ChartImage
          ...
          caption="Major nuclear power purchase agreements signed by Big Tech companies to power AI data centers. Sources: Company announcements, 2024–2025."
        />
        ...
        >
          <p className="mb-3">
            The most defensible position is that <strong>both perspectives are partially correct</strong> — and the truth depends entirely on the level of analysis and geographic specificity. At the national and global scale, data center resource consumption is genuinely a small fraction of totals. At the local scale, in communities like Northern Virginia, eastern Washington State, and parts of Arizona, the impacts are concentrated enough to cause genuine harm without proper mitigation.
          </p>
          <p className="mb-3">
