 ...
 * SocialBar.tsx
 *
 * A row of icon links for X, YouTube, Instagram, and TikTok.
 * Accepts a links object from Sanity site settings; silently omits
 * any platform whose URL is not set.
 *
